...
# from modelUtils.mobile_facenet_torch import MobileFaceNet
...
if __name__ == '__main__':
    ...
    onnxModelName = "mobilefacenet_"+ str(ver) +".onnx"
    # simpOnnxMdl = "sim_mobilefacenet_" + str(ver) +".onnx"
    # onnxModelWeight = "/home/ali/Projlab/Nist/Models/pytorch/model_mobilefacenet.pth"
