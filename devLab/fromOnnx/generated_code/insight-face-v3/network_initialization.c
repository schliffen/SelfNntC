...
kernels = (fp_t***) malloc(204 * sizeof(fp_t**));
biases = (fp_t**) malloc(310 * sizeof(fp_t*));
...
// Inputs
// (1, 1, 1)
buffer_2151 = (fp_t**) malloc(1 * sizeof(fp_t*));

for(uint32_t kernel = 0; kernel < 1; kernel++){
    buffer_2151[kernel] = (fp_t*) malloc(1*1 * sizeof(fp_t));
}



kernels[1] = buffer_2151;
...
// Inputs
// (1, 1, 1)
buffer_2152 = (fp_t**) malloc(1 * sizeof(fp_t*));

for(uint32_t kernel = 0; kernel < 1; kernel++){
    buffer_2152[kernel] = (fp_t*) malloc(1*1 * sizeof(fp_t));
}



kernels[3] = buffer_2152;
...
kernels[5] = &buffer_layer1_0_se_fc_0_weight;
...
// Inputs
// (1,)
buffer_layer1_0_se_fc_1_weight = (fp_t*) malloc(1 * sizeof(fp_t));



biases[8] = buffer_layer1_0_se_fc_1_weight;
...
kernels[6] = &buffer_layer1_0_se_fc_2_weight;
...
biases[9] = buffer_layer1_0_se_fc_2_bias;
...
// Inputs
// (1, 1, 1)
buffer_2155 = (fp_t**) malloc(1 * sizeof(fp_t*));

for(uint32_t kernel = 0; kernel < 1; kernel++){
    buffer_2155[kernel] = (fp_t*) malloc(1*1 * sizeof(fp_t));
}



kernels[7] = buffer_2155;
...
biases[10] = buffer_layer1_1_bn0_weight;
...
biases[11] = buffer_layer1_1_bn0_bias;
...
biases[12] = buffer_layer1_1_bn0_running_mean;
...
biases[13] = buffer_layer1_1_bn0_running_var;
...
// Inputs
// (1, 1, 1)
buffer_2156 = (fp_t**) malloc(1 * sizeof(fp_t*));

for(uint32_t kernel = 0; kernel < 1; kernel++){
    buffer_2156[kernel] = (fp_t*) malloc(1*1 * sizeof(fp_t));
}



kernels[9] = buffer_2156;
...
kernels[11] = &buffer_layer1_1_se_fc_0_weight;
...
biases[16] = buffer_layer1_1_se_fc_0_bias;
...
// Inputs
// (1,)
buffer_layer1_1_se_fc_1_weight = (fp_t*) malloc(1 * sizeof(fp_t));



biases[17] = buffer_layer1_1_se_fc_1_weight;
...
kernels[12] = &buffer_layer1_1_se_fc_2_weight;
...
biases[18] = buffer_layer1_1_se_fc_2_bias;
...
// Inputs
// (1, 1, 1)
buffer_2159 = (fp_t**) malloc(1 * sizeof(fp_t*));

for(uint32_t kernel = 0; kernel < 1; kernel++){
    buffer_2159[kernel] = (fp_t*) malloc(1*1 * sizeof(fp_t));
}



kernels[13] = buffer_2159;
...
biases[19] = buffer_layer1_2_bn0_weight;
...
biases[20] = buffer_layer1_2_bn0_bias;
...
biases[21] = buffer_layer1_2_bn0_running_mean;
...
biases[22] = buffer_layer1_2_bn0_running_var;
...
// Inputs
// (1, 1, 1)
buffer_2160 = (fp_t**) malloc(1 * sizeof(fp_t*));

for(uint32_t kernel = 0; kernel < 1; kernel++){
    buffer_2160[kernel] = (fp_t*) malloc(1*1 * sizeof(fp_t));
}



kernels[15] = buffer_2160;
...
kernels[17] = &buffer_layer1_2_se_fc_0_weight;
...
biases[25] = buffer_layer1_2_se_fc_0_bias;
...
// Inputs
// (1,)
buffer_layer1_2_se_fc_1_weight = (fp_t*) malloc(1 * sizeof(fp_t));



biases[26] = buffer_layer1_2_se_fc_1_weight;
...
kernels[18] = &buffer_layer1_2_se_fc_2_weight;
...
biases[27] = buffer_layer1_2_se_fc_2_bias;
...
// Inputs
// (1, 1, 1)
buffer_2163 = (fp_t**) malloc(1 * sizeof(fp_t*));

for(uint32_t kernel = 0; kernel < 1; kernel++){
    buffer_2163[kernel] = (fp_t*) malloc(1*1 * sizeof(fp_t));
}



kernels[19] = buffer_2163;
...
biases[28] = buffer_layer2_0_bn0_weight;
...
biases[29] = buffer_layer2_0_bn0_bias;
...
biases[30] = buffer_layer2_0_bn0_running_mean;
...
biases[31] = buffer_layer2_0_bn0_running_var;
...
// Inputs
// (1, 1, 1)
buffer_2164 = (fp_t**) malloc(1 * sizeof(fp_t*));

for(uint32_t kernel = 0; kernel < 1; kernel++){
    buffer_2164[kernel] = (fp_t*) malloc(1*1 * sizeof(fp_t));
}



kernels[21] = buffer_2164;
...
kernels[23] = &buffer_layer2_0_se_fc_0_weight;
...
biases[34] = buffer_layer2_0_se_fc_0_bias;
...
// Inputs
// (1,)
buffer_layer2_0_se_fc_1_weight = (fp_t*) malloc(1 * sizeof(fp_t));



biases[35] = buffer_layer2_0_se_fc_1_weight;
...
kernels[24] = &buffer_layer2_0_se_fc_2_weight;
...
biases[36] = buffer_layer2_0_se_fc_2_bias;
...
// Inputs
// (1, 1, 1)
buffer_2167 = (fp_t**) malloc(1 * sizeof(fp_t*));

for(uint32_t kernel = 0; kernel < 1; kernel++){
    buffer_2167[kernel] = (fp_t*) malloc(1*1 * sizeof(fp_t));
}



kernels[26] = buffer_2167;
...
biases[38] = buffer_layer2_1_bn0_weight;
...
biases[39] = buffer_layer2_1_bn0_bias;
...
biases[40] = buffer_layer2_1_bn0_running_mean;
...
biases[41] = buffer_layer2_1_bn0_running_var;
...
// Inputs
// (1, 1, 1)
buffer_2168 = (fp_t**) malloc(1 * sizeof(fp_t*));

for(uint32_t kernel = 0; kernel < 1; kernel++){
    buffer_2168[kernel] = (fp_t*) malloc(1*1 * sizeof(fp_t));
}



kernels[28] = buffer_2168;
...
kernels[30] = &buffer_layer2_1_se_fc_0_weight;
...
biases[44] = buffer_layer2_1_se_fc_0_bias;
...
// Inputs
// (1,)
buffer_layer2_1_se_fc_1_weight = (fp_t*) malloc(1 * sizeof(fp_t));



biases[45] = buffer_layer2_1_se_fc_1_weight;
...
kernels[31] = &buffer_layer2_1_se_fc_2_weight;
...
biases[46] = buffer_layer2_1_se_fc_2_bias;
...
// Inputs
// (1, 1, 1)
buffer_2171 = (fp_t**) malloc(1 * sizeof(fp_t*));

for(uint32_t kernel = 0; kernel < 1; kernel++){
    buffer_2171[kernel] = (fp_t*) malloc(1*1 * sizeof(fp_t));
}



kernels[32] = buffer_2171;
...
biases[47] = buffer_layer2_2_bn0_weight;
...
biases[48] = buffer_layer2_2_bn0_bias;
...
biases[49] = buffer_layer2_2_bn0_running_mean;
...
biases[50] = buffer_layer2_2_bn0_running_var;
...
// Inputs
// (1, 1, 1)
buffer_2172 = (fp_t**) malloc(1 * sizeof(fp_t*));

for(uint32_t kernel = 0; kernel < 1; kernel++){
    buffer_2172[kernel] = (fp_t*) malloc(1*1 * sizeof(fp_t));
}



kernels[34] = buffer_2172;
...
kernels[36] = &buffer_layer2_2_se_fc_0_weight;
...
biases[53] = buffer_layer2_2_se_fc_0_bias;
...
// Inputs
// (1,)
buffer_layer2_2_se_fc_1_weight = (fp_t*) malloc(1 * sizeof(fp_t));



biases[54] = buffer_layer2_2_se_fc_1_weight;
...
kernels[37] = &buffer_layer2_2_se_fc_2_weight;
...
biases[55] = buffer_layer2_2_se_fc_2_bias;
...
// Inputs
// (1, 1, 1)
buffer_2175 = (fp_t**) malloc(1 * sizeof(fp_t*));

for(uint32_t kernel = 0; kernel < 1; kernel++){
    buffer_2175[kernel] = (fp_t*) malloc(1*1 * sizeof(fp_t));
}



kernels[38] = buffer_2175;
...
biases[56] = buffer_layer2_3_bn0_weight;
...
biases[57] = buffer_layer2_3_bn0_bias;
...
biases[58] = buffer_layer2_3_bn0_running_mean;
...
biases[59] = buffer_layer2_3_bn0_running_var;
...
// Inputs
// (1, 1, 1)
buffer_2176 = (fp_t**) malloc(1 * sizeof(fp_t*));

for(uint32_t kernel = 0; kernel < 1; kernel++){
    buffer_2176[kernel] = (fp_t*) malloc(1*1 * sizeof(fp_t));
}



kernels[40] = buffer_2176;
...
kernels[42] = &buffer_layer2_3_se_fc_0_weight;
...
biases[62] = buffer_layer2_3_se_fc_0_bias;
...
// Inputs
// (1,)
buffer_layer2_3_se_fc_1_weight = (fp_t*) malloc(1 * sizeof(fp_t));



biases[63] = buffer_layer2_3_se_fc_1_weight;
...
kernels[43] = &buffer_layer2_3_se_fc_2_weight;
...
biases[64] = buffer_layer2_3_se_fc_2_bias;
...
// Inputs
// (1, 1, 1)
buffer_2179 = (fp_t**) malloc(1 * sizeof(fp_t*));

for(uint32_t kernel = 0; kernel < 1; kernel++){
    buffer_2179[kernel] = (fp_t*) malloc(1*1 * sizeof(fp_t));
}



kernels[44] = buffer_2179;
...
biases[65] = buffer_layer3_0_bn0_weight;
...
biases[66] = buffer_layer3_0_bn0_bias;
...
biases[67] = buffer_layer3_0_bn0_running_mean;
...
biases[68] = buffer_layer3_0_bn0_running_var;
...
// Inputs
// (1, 1, 1)
buffer_2180 = (fp_t**) malloc(1 * sizeof(fp_t*));

for(uint32_t kernel = 0; kernel < 1; kernel++){
    buffer_2180[kernel] = (fp_t*) malloc(1*1 * sizeof(fp_t));
}



kernels[46] = buffer_2180;
...
kernels[48] = &buffer_layer3_0_se_fc_0_weight;
...
biases[71] = buffer_layer3_0_se_fc_0_bias;
...
// Inputs
// (1,)
buffer_layer3_0_se_fc_1_weight = (fp_t*) malloc(1 * sizeof(fp_t));



biases[72] = buffer_layer3_0_se_fc_1_weight;
...
kernels[49] = &buffer_layer3_0_se_fc_2_weight;
...
biases[73] = buffer_layer3_0_se_fc_2_bias;
...
// Inputs
// (1, 1, 1)
buffer_2183 = (fp_t**) malloc(1 * sizeof(fp_t*));

for(uint32_t kernel = 0; kernel < 1; kernel++){
    buffer_2183[kernel] = (fp_t*) malloc(1*1 * sizeof(fp_t));
}



kernels[51] = buffer_2183;
...
biases[75] = buffer_layer3_1_bn0_weight;
...
biases[76] = buffer_layer3_1_bn0_bias;
...
biases[77] = buffer_layer3_1_bn0_running_mean;
...
biases[78] = buffer_layer3_1_bn0_running_var;
...
// Inputs
// (1, 1, 1)
buffer_2184 = (fp_t**) malloc(1 * sizeof(fp_t*));

for(uint32_t kernel = 0; kernel < 1; kernel++){
    buffer_2184[kernel] = (fp_t*) malloc(1*1 * sizeof(fp_t));
}



kernels[53] = buffer_2184;
...
kernels[55] = &buffer_layer3_1_se_fc_0_weight;
...
biases[81] = buffer_layer3_1_se_fc_0_bias;
...
// Inputs
// (1,)
buffer_layer3_1_se_fc_1_weight = (fp_t*) malloc(1 * sizeof(fp_t));



biases[82] = buffer_layer3_1_se_fc_1_weight;
...
kernels[56] = &buffer_layer3_1_se_fc_2_weight;
...
biases[83] = buffer_layer3_1_se_fc_2_bias;
...
// Inputs
// (1, 1, 1)
buffer_2187 = (fp_t**) malloc(1 * sizeof(fp_t*));

for(uint32_t kernel = 0; kernel < 1; kernel++){
    buffer_2187[kernel] = (fp_t*) malloc(1*1 * sizeof(fp_t));
}



kernels[57] = buffer_2187;
...
biases[84] = buffer_layer3_2_bn0_weight;
...
biases[85] = buffer_layer3_2_bn0_bias;
...
biases[86] = buffer_layer3_2_bn0_running_mean;
...
biases[87] = buffer_layer3_2_bn0_running_var;
...
// Inputs
// (1, 1, 1)
buffer_2188 = (fp_t**) malloc(1 * sizeof(fp_t*));

for(uint32_t kernel = 0; kernel < 1; kernel++){
    buffer_2188[kernel] = (fp_t*) malloc(1*1 * sizeof(fp_t));
}



kernels[59] = buffer_2188;
...
kernels[61] = &buffer_layer3_2_se_fc_0_weight;
...
biases[90] = buffer_layer3_2_se_fc_0_bias;
...
// Inputs
// (1,)
buffer_layer3_2_se_fc_1_weight = (fp_t*) malloc(1 * sizeof(fp_t));



biases[91] = buffer_layer3_2_se_fc_1_weight;
...
kernels[62] = &buffer_layer3_2_se_fc_2_weight;
...
biases[92] = buffer_layer3_2_se_fc_2_bias;
...
// Inputs
// (1, 1, 1)
buffer_2191 = (fp_t**) malloc(1 * sizeof(fp_t*));

for(uint32_t kernel = 0; kernel < 1; kernel++){
    buffer_2191[kernel] = (fp_t*) malloc(1*1 * sizeof(fp_t));
}



kernels[63] = buffer_2191;
...
biases[93] = buffer_layer3_3_bn0_weight;
...
biases[94] = buffer_layer3_3_bn0_bias;
...
biases[95] = buffer_layer3_3_bn0_running_mean;
...
biases[96] = buffer_layer3_3_bn0_running_var;
...
// Inputs
// (1, 1, 1)
buffer_2192 = (fp_t**) malloc(1 * sizeof(fp_t*));

for(uint32_t kernel = 0; kernel < 1; kernel++){
    buffer_2192[kernel] = (fp_t*) malloc(1*1 * sizeof(fp_t));
}



kernels[65] = buffer_2192;
...
kernels[67] = &buffer_layer3_3_se_fc_0_weight;
...
biases[99] = buffer_layer3_3_se_fc_0_bias;
...
// Inputs
// (1,)
buffer_layer3_3_se_fc_1_weight = (fp_t*) malloc(1 * sizeof(fp_t));



biases[100] = buffer_layer3_3_se_fc_1_weight;
...
kernels[68] = &buffer_layer3_3_se_fc_2_weight;
...
biases[101] = buffer_layer3_3_se_fc_2_bias;
...
// Inputs
// (1, 1, 1)
buffer_2195 = (fp_t**) malloc(1 * sizeof(fp_t*));

for(uint32_t kernel = 0; kernel < 1; kernel++){
    buffer_2195[kernel] = (fp_t*) malloc(1*1 * sizeof(fp_t));
}



kernels[69] = buffer_2195;
...
biases[102] = buffer_layer3_4_bn0_weight;
...
biases[103] = buffer_layer3_4_bn0_bias;
...
biases[104] = buffer_layer3_4_bn0_running_mean;
...
biases[105] = buffer_layer3_4_bn0_running_var;
...
// Inputs
// (1, 1, 1)
buffer_2196 = (fp_t**) malloc(1 * sizeof(fp_t*));

for(uint32_t kernel = 0; kernel < 1; kernel++){
    buffer_2196[kernel] = (fp_t*) malloc(1*1 * sizeof(fp_t));
}



kernels[71] = buffer_2196;
...
kernels[73] = &buffer_layer3_4_se_fc_0_weight;
...
biases[108] = buffer_layer3_4_se_fc_0_bias;
...
// Inputs
// (1,)
buffer_layer3_4_se_fc_1_weight = (fp_t*) malloc(1 * sizeof(fp_t));



biases[109] = buffer_layer3_4_se_fc_1_weight;
...
kernels[74] = &buffer_layer3_4_se_fc_2_weight;
...
biases[110] = buffer_layer3_4_se_fc_2_bias;
...
// Inputs
// (1, 1, 1)
buffer_2199 = (fp_t**) malloc(1 * sizeof(fp_t*));

for(uint32_t kernel = 0; kernel < 1; kernel++){
    buffer_2199[kernel] = (fp_t*) malloc(1*1 * sizeof(fp_t));
}



kernels[75] = buffer_2199;
...
biases[111] = buffer_layer3_5_bn0_weight;
...
biases[112] = buffer_layer3_5_bn0_bias;
...
biases[113] = buffer_layer3_5_bn0_running_mean;
...
biases[114] = buffer_layer3_5_bn0_running_var;
...
// Inputs
// (1, 1, 1)
buffer_2200 = (fp_t**) malloc(1 * sizeof(fp_t*));

for(uint32_t kernel = 0; kernel < 1; kernel++){
    buffer_2200[kernel] = (fp_t*) malloc(1*1 * sizeof(fp_t));
}



kernels[77] = buffer_2200;
...
kernels[79] = &buffer_layer3_5_se_fc_0_weight;
...
biases[117] = buffer_layer3_5_se_fc_0_bias;
...
// Inputs
// (1,)
buffer_layer3_5_se_fc_1_weight = (fp_t*) malloc(1 * sizeof(fp_t));



biases[118] = buffer_layer3_5_se_fc_1_weight;
...
kernels[80] = &buffer_layer3_5_se_fc_2_weight;
...
biases[119] = buffer_layer3_5_se_fc_2_bias;
...
// Inputs
// (1, 1, 1)
buffer_2203 = (fp_t**) malloc(1 * sizeof(fp_t*));

for(uint32_t kernel = 0; kernel < 1; kernel++){
    buffer_2203[kernel] = (fp_t*) malloc(1*1 * sizeof(fp_t));
}



kernels[81] = buffer_2203;
...
biases[120] = buffer_layer3_6_bn0_weight;
...
biases[121] = buffer_layer3_6_bn0_bias;
...
biases[122] = buffer_layer3_6_bn0_running_mean;
...
biases[123] = buffer_layer3_6_bn0_running_var;
...
// Inputs
// (1, 1, 1)
buffer_2204 = (fp_t**) malloc(1 * sizeof(fp_t*));

for(uint32_t kernel = 0; kernel < 1; kernel++){
    buffer_2204[kernel] = (fp_t*) malloc(1*1 * sizeof(fp_t));
}



kernels[83] = buffer_2204;
...
kernels[85] = &buffer_layer3_6_se_fc_0_weight;
...
biases[126] = buffer_layer3_6_se_fc_0_bias;
...
// Inputs
// (1,)
buffer_layer3_6_se_fc_1_weight = (fp_t*) malloc(1 * sizeof(fp_t));



biases[127] = buffer_layer3_6_se_fc_1_weight;
...
kernels[86] = &buffer_layer3_6_se_fc_2_weight;
...
biases[128] = buffer_layer3_6_se_fc_2_bias;
...
// Inputs
// (1, 1, 1)
buffer_2207 = (fp_t**) malloc(1 * sizeof(fp_t*));

for(uint32_t kernel = 0; kernel < 1; kernel++){
    buffer_2207[kernel] = (fp_t*) malloc(1*1 * sizeof(fp_t));
}



kernels[87] = buffer_2207;
...
biases[129] = buffer_layer3_7_bn0_weight;
...
biases[130] = buffer_layer3_7_bn0_bias;
...
biases[131] = buffer_layer3_7_bn0_running_mean;
...
biases[132] = buffer_layer3_7_bn0_running_var;
...
// Inputs
// (1, 1, 1)
buffer_2208 = (fp_t**) malloc(1 * sizeof(fp_t*));

for(uint32_t kernel = 0; kernel < 1; kernel++){
    buffer_2208[kernel] = (fp_t*) malloc(1*1 * sizeof(fp_t));
}



kernels[89] = buffer_2208;
...
kernels[91] = &buffer_layer3_7_se_fc_0_weight;
...
biases[135] = buffer_layer3_7_se_fc_0_bias;
...
// Inputs
// (1,)
buffer_layer3_7_se_fc_1_weight = (fp_t*) malloc(1 * sizeof(fp_t));



biases[136] = buffer_layer3_7_se_fc_1_weight;
...
kernels[92] = &buffer_layer3_7_se_fc_2_weight;
...
biases[137] = buffer_layer3_7_se_fc_2_bias;
...
// Inputs
// (1, 1, 1)
buffer_2211 = (fp_t**) malloc(1 * sizeof(fp_t*));

for(uint32_t kernel = 0; kernel < 1; kernel++){
    buffer_2211[kernel] = (fp_t*) malloc(1*1 * sizeof(fp_t));
}



kernels[93] = buffer_2211;
...
biases[138] = buffer_layer3_8_bn0_weight;
...
biases[139] = buffer_layer3_8_bn0_bias;
...
biases[140] = buffer_layer3_8_bn0_running_mean;
...
biases[141] = buffer_layer3_8_bn0_running_var;
...
// Inputs
// (1, 1, 1)
buffer_2212 = (fp_t**) malloc(1 * sizeof(fp_t*));

for(uint32_t kernel = 0; kernel < 1; kernel++){
    buffer_2212[kernel] = (fp_t*) malloc(1*1 * sizeof(fp_t));
}



kernels[95] = buffer_2212;
...
kernels[97] = &buffer_layer3_8_se_fc_0_weight;
...
biases[144] = buffer_layer3_8_se_fc_0_bias;
...
// Inputs
// (1,)
buffer_layer3_8_se_fc_1_weight = (fp_t*) malloc(1 * sizeof(fp_t));



biases[145] = buffer_layer3_8_se_fc_1_weight;
...
kernels[98] = &buffer_layer3_8_se_fc_2_weight;
...
biases[146] = buffer_layer3_8_se_fc_2_bias;
...
// Inputs
// (1, 1, 1)
buffer_2215 = (fp_t**) malloc(1 * sizeof(fp_t*));

for(uint32_t kernel = 0; kernel < 1; kernel++){
    buffer_2215[kernel] = (fp_t*) malloc(1*1 * sizeof(fp_t));
}



kernels[99] = buffer_2215;
...
biases[147] = buffer_layer3_9_bn0_weight;
...
biases[148] = buffer_layer3_9_bn0_bias;
...
biases[149] = buffer_layer3_9_bn0_running_mean;
...
biases[150] = buffer_layer3_9_bn0_running_var;
...
// Inputs
// (1, 1, 1)
buffer_2216 = (fp_t**) malloc(1 * sizeof(fp_t*));

for(uint32_t kernel = 0; kernel < 1; kernel++){
    buffer_2216[kernel] = (fp_t*) malloc(1*1 * sizeof(fp_t));
}



kernels[101] = buffer_2216;
...
kernels[103] = &buffer_layer3_9_se_fc_0_weight;
...
biases[153] = buffer_layer3_9_se_fc_0_bias;
...
// Inputs
// (1,)
buffer_layer3_9_se_fc_1_weight = (fp_t*) malloc(1 * sizeof(fp_t));



biases[154] = buffer_layer3_9_se_fc_1_weight;
...
kernels[104] = &buffer_layer3_9_se_fc_2_weight;
...
biases[155] = buffer_layer3_9_se_fc_2_bias;
...
// Inputs
// (1, 1, 1)
buffer_2219 = (fp_t**) malloc(1 * sizeof(fp_t*));

for(uint32_t kernel = 0; kernel < 1; kernel++){
    buffer_2219[kernel] = (fp_t*) malloc(1*1 * sizeof(fp_t));
}



kernels[105] = buffer_2219;
...
biases[156] = buffer_layer3_10_bn0_weight;
...
biases[157] = buffer_layer3_10_bn0_bias;
...
biases[158] = buffer_layer3_10_bn0_running_mean;
...
biases[159] = buffer_layer3_10_bn0_running_var;
...
// Inputs
// (1, 1, 1)
buffer_2220 = (fp_t**) malloc(1 * sizeof(fp_t*));

for(uint32_t kernel = 0; kernel < 1; kernel++){
    buffer_2220[kernel] = (fp_t*) malloc(1*1 * sizeof(fp_t));
}



kernels[107] = buffer_2220;
...
kernels[109] = &buffer_layer3_10_se_fc_0_weight;
...
biases[162] = buffer_layer3_10_se_fc_0_bias;
...
// Inputs
// (1,)
buffer_layer3_10_se_fc_1_weight = (fp_t*) malloc(1 * sizeof(fp_t));



biases[163] = buffer_layer3_10_se_fc_1_weight;
...
kernels[110] = &buffer_layer3_10_se_fc_2_weight;
...
biases[164] = buffer_layer3_10_se_fc_2_bias;
...
// Inputs
// (1, 1, 1)
buffer_2223 = (fp_t**) malloc(1 * sizeof(fp_t*));

for(uint32_t kernel = 0; kernel < 1; kernel++){
    buffer_2223[kernel] = (fp_t*) malloc(1*1 * sizeof(fp_t));
}



kernels[111] = buffer_2223;
...
biases[165] = buffer_layer3_11_bn0_weight;
...
biases[166] = buffer_layer3_11_bn0_bias;
...
biases[167] = buffer_layer3_11_bn0_running_mean;
...
biases[168] = buffer_layer3_11_bn0_running_var;
...
// Inputs
// (1, 1, 1)
buffer_2224 = (fp_t**) malloc(1 * sizeof(fp_t*));

for(uint32_t kernel = 0; kernel < 1; kernel++){
    buffer_2224[kernel] = (fp_t*) malloc(1*1 * sizeof(fp_t));
}



kernels[113] = buffer_2224;
...
kernels[115] = &buffer_layer3_11_se_fc_0_weight;
...
biases[171] = buffer_layer3_11_se_fc_0_bias;
...
// Inputs
// (1,)
buffer_layer3_11_se_fc_1_weight = (fp_t*) malloc(1 * sizeof(fp_t));



biases[172] = buffer_layer3_11_se_fc_1_weight;
...
kernels[116] = &buffer_layer3_11_se_fc_2_weight;
...
biases[173] = buffer_layer3_11_se_fc_2_bias;
...
// Inputs
// (1, 1, 1)
buffer_2227 = (fp_t**) malloc(1 * sizeof(fp_t*));

for(uint32_t kernel = 0; kernel < 1; kernel++){
    buffer_2227[kernel] = (fp_t*) malloc(1*1 * sizeof(fp_t));
}



kernels[117] = buffer_2227;
...
biases[174] = buffer_layer3_12_bn0_weight;
...
biases[175] = buffer_layer3_12_bn0_bias;
...
biases[176] = buffer_layer3_12_bn0_running_mean;
...
biases[177] = buffer_layer3_12_bn0_running_var;
...
// Inputs
// (1, 1, 1)
buffer_2228 = (fp_t**) malloc(1 * sizeof(fp_t*));

for(uint32_t kernel = 0; kernel < 1; kernel++){
    buffer_2228[kernel] = (fp_t*) malloc(1*1 * sizeof(fp_t));
}



kernels[119] = buffer_2228;
...
kernels[121] = &buffer_layer3_12_se_fc_0_weight;
...
biases[180] = buffer_layer3_12_se_fc_0_bias;
...
// Inputs
// (1,)
buffer_layer3_12_se_fc_1_weight = (fp_t*) malloc(1 * sizeof(fp_t));



biases[181] = buffer_layer3_12_se_fc_1_weight;
...
kernels[122] = &buffer_layer3_12_se_fc_2_weight;
...
biases[182] = buffer_layer3_12_se_fc_2_bias;
...
// Inputs
// (1, 1, 1)
buffer_2231 = (fp_t**) malloc(1 * sizeof(fp_t*));

for(uint32_t kernel = 0; kernel < 1; kernel++){
    buffer_2231[kernel] = (fp_t*) malloc(1*1 * sizeof(fp_t));
}



kernels[123] = buffer_2231;
...
biases[183] = buffer_layer3_13_bn0_weight;
...
biases[184] = buffer_layer3_13_bn0_bias;
...
biases[185] = buffer_layer3_13_bn0_running_mean;
...
biases[186] = buffer_layer3_13_bn0_running_var;
...
// Inputs
// (1, 1, 1)
buffer_2232 = (fp_t**) malloc(1 * sizeof(fp_t*));

for(uint32_t kernel = 0; kernel < 1; kernel++){
    buffer_2232[kernel] = (fp_t*) malloc(1*1 * sizeof(fp_t));
}



kernels[125] = buffer_2232;
...
kernels[127] = &buffer_layer3_13_se_fc_0_weight;
...
biases[189] = buffer_layer3_13_se_fc_0_bias;
...
// Inputs
// (1,)
buffer_layer3_13_se_fc_1_weight = (fp_t*) malloc(1 * sizeof(fp_t));



biases[190] = buffer_layer3_13_se_fc_1_weight;
...
kernels[128] = &buffer_layer3_13_se_fc_2_weight;
...
biases[191] = buffer_layer3_13_se_fc_2_bias;
...
// Inputs
// (1, 1, 1)
buffer_2235 = (fp_t**) malloc(1 * sizeof(fp_t*));

for(uint32_t kernel = 0; kernel < 1; kernel++){
    buffer_2235[kernel] = (fp_t*) malloc(1*1 * sizeof(fp_t));
}



kernels[129] = buffer_2235;
...
biases[192] = buffer_layer3_14_bn0_weight;
...
biases[193] = buffer_layer3_14_bn0_bias;
...
biases[194] = buffer_layer3_14_bn0_running_mean;
...
biases[195] = buffer_layer3_14_bn0_running_var;
...
// Inputs
// (1, 1, 1)
buffer_2236 = (fp_t**) malloc(1 * sizeof(fp_t*));

for(uint32_t kernel = 0; kernel < 1; kernel++){
    buffer_2236[kernel] = (fp_t*) malloc(1*1 * sizeof(fp_t));
}



kernels[131] = buffer_2236;
...
kernels[133] = &buffer_layer3_14_se_fc_0_weight;
...
biases[198] = buffer_layer3_14_se_fc_0_bias;
...
// Inputs
// (1,)
buffer_layer3_14_se_fc_1_weight = (fp_t*) malloc(1 * sizeof(fp_t));



biases[199] = buffer_layer3_14_se_fc_1_weight;
...
kernels[134] = &buffer_layer3_14_se_fc_2_weight;
...
biases[200] = buffer_layer3_14_se_fc_2_bias;
...
// Inputs
// (1, 1, 1)
buffer_2239 = (fp_t**) malloc(1 * sizeof(fp_t*));

for(uint32_t kernel = 0; kernel < 1; kernel++){
    buffer_2239[kernel] = (fp_t*) malloc(1*1 * sizeof(fp_t));
}



kernels[135] = buffer_2239;
...
biases[201] = buffer_layer3_15_bn0_weight;
...
biases[202] = buffer_layer3_15_bn0_bias;
...
biases[203] = buffer_layer3_15_bn0_running_mean;
...
biases[204] = buffer_layer3_15_bn0_running_var;
...
// Inputs
// (1, 1, 1)
buffer_2240 = (fp_t**) malloc(1 * sizeof(fp_t*));

for(uint32_t kernel = 0; kernel < 1; kernel++){
    buffer_2240[kernel] = (fp_t*) malloc(1*1 * sizeof(fp_t));
}



kernels[137] = buffer_2240;
...
kernels[139] = &buffer_layer3_15_se_fc_0_weight;
...
biases[207] = buffer_layer3_15_se_fc_0_bias;
...
// Inputs
// (1,)
buffer_layer3_15_se_fc_1_weight = (fp_t*) malloc(1 * sizeof(fp_t));



biases[208] = buffer_layer3_15_se_fc_1_weight;
...
kernels[140] = &buffer_layer3_15_se_fc_2_weight;
...
biases[209] = buffer_layer3_15_se_fc_2_bias;
...
// Inputs
// (1, 1, 1)
buffer_2243 = (fp_t**) malloc(1 * sizeof(fp_t*));

for(uint32_t kernel = 0; kernel < 1; kernel++){
    buffer_2243[kernel] = (fp_t*) malloc(1*1 * sizeof(fp_t));
}



kernels[141] = buffer_2243;
...
biases[210] = buffer_layer3_16_bn0_weight;
...
biases[211] = buffer_layer3_16_bn0_bias;
...
biases[212] = buffer_layer3_16_bn0_running_mean;
...
biases[213] = buffer_layer3_16_bn0_running_var;
...
// Inputs
// (1, 1, 1)
buffer_2244 = (fp_t**) malloc(1 * sizeof(fp_t*));

for(uint32_t kernel = 0; kernel < 1; kernel++){
    buffer_2244[kernel] = (fp_t*) malloc(1*1 * sizeof(fp_t));
}



kernels[143] = buffer_2244;
...
kernels[145] = &buffer_layer3_16_se_fc_0_weight;
...
biases[216] = buffer_layer3_16_se_fc_0_bias;
...
// Inputs
// (1,)
buffer_layer3_16_se_fc_1_weight = (fp_t*) malloc(1 * sizeof(fp_t));



biases[217] = buffer_layer3_16_se_fc_1_weight;
...
kernels[146] = &buffer_layer3_16_se_fc_2_weight;
...
biases[218] = buffer_layer3_16_se_fc_2_bias;
...
// Inputs
// (1, 1, 1)
buffer_2247 = (fp_t**) malloc(1 * sizeof(fp_t*));

for(uint32_t kernel = 0; kernel < 1; kernel++){
    buffer_2247[kernel] = (fp_t*) malloc(1*1 * sizeof(fp_t));
}



kernels[147] = buffer_2247;
...
biases[219] = buffer_layer3_17_bn0_weight;
...
biases[220] = buffer_layer3_17_bn0_bias;
...
biases[221] = buffer_layer3_17_bn0_running_mean;
...
biases[222] = buffer_layer3_17_bn0_running_var;
...
// Inputs
// (1, 1, 1)
buffer_2248 = (fp_t**) malloc(1 * sizeof(fp_t*));

for(uint32_t kernel = 0; kernel < 1; kernel++){
    buffer_2248[kernel] = (fp_t*) malloc(1*1 * sizeof(fp_t));
}



kernels[149] = buffer_2248;
...
kernels[151] = &buffer_layer3_17_se_fc_0_weight;
...
biases[225] = buffer_layer3_17_se_fc_0_bias;
...
// Inputs
// (1,)
buffer_layer3_17_se_fc_1_weight = (fp_t*) malloc(1 * sizeof(fp_t));



biases[226] = buffer_layer3_17_se_fc_1_weight;
...
kernels[152] = &buffer_layer3_17_se_fc_2_weight;
...
biases[227] = buffer_layer3_17_se_fc_2_bias;
...
// Inputs
// (1, 1, 1)
buffer_2251 = (fp_t**) malloc(1 * sizeof(fp_t*));

for(uint32_t kernel = 0; kernel < 1; kernel++){
    buffer_2251[kernel] = (fp_t*) malloc(1*1 * sizeof(fp_t));
}



kernels[153] = buffer_2251;
...
biases[228] = buffer_layer3_18_bn0_weight;
...
biases[229] = buffer_layer3_18_bn0_bias;
...
biases[230] = buffer_layer3_18_bn0_running_mean;
...
biases[231] = buffer_layer3_18_bn0_running_var;
...
// Inputs
// (1, 1, 1)
buffer_2252 = (fp_t**) malloc(1 * sizeof(fp_t*));

for(uint32_t kernel = 0; kernel < 1; kernel++){
    buffer_2252[kernel] = (fp_t*) malloc(1*1 * sizeof(fp_t));
}



kernels[155] = buffer_2252;
...
kernels[157] = &buffer_layer3_18_se_fc_0_weight;
...
biases[234] = buffer_layer3_18_se_fc_0_bias;
...
// Inputs
// (1,)
buffer_layer3_18_se_fc_1_weight = (fp_t*) malloc(1 * sizeof(fp_t));



biases[235] = buffer_layer3_18_se_fc_1_weight;
...
kernels[158] = &buffer_layer3_18_se_fc_2_weight;
...
biases[236] = buffer_layer3_18_se_fc_2_bias;
...
// Inputs
// (1, 1, 1)
buffer_2255 = (fp_t**) malloc(1 * sizeof(fp_t*));

for(uint32_t kernel = 0; kernel < 1; kernel++){
    buffer_2255[kernel] = (fp_t*) malloc(1*1 * sizeof(fp_t));
}



kernels[159] = buffer_2255;
...
biases[237] = buffer_layer3_19_bn0_weight;
...
biases[238] = buffer_layer3_19_bn0_bias;
...
biases[239] = buffer_layer3_19_bn0_running_mean;
...
biases[240] = buffer_layer3_19_bn0_running_var;
...
// Inputs
// (1, 1, 1)
buffer_2256 = (fp_t**) malloc(1 * sizeof(fp_t*));

for(uint32_t kernel = 0; kernel < 1; kernel++){
    buffer_2256[kernel] = (fp_t*) malloc(1*1 * sizeof(fp_t));
}



kernels[161] = buffer_2256;
...
kernels[163] = &buffer_layer3_19_se_fc_0_weight;
...
biases[243] = buffer_layer3_19_se_fc_0_bias;
...
// Inputs
// (1,)
buffer_layer3_19_se_fc_1_weight = (fp_t*) malloc(1 * sizeof(fp_t));



biases[244] = buffer_layer3_19_se_fc_1_weight;
...
kernels[164] = &buffer_layer3_19_se_fc_2_weight;
...
biases[245] = buffer_layer3_19_se_fc_2_bias;
...
// Inputs
// (1, 1, 1)
buffer_2259 = (fp_t**) malloc(1 * sizeof(fp_t*));

for(uint32_t kernel = 0; kernel < 1; kernel++){
    buffer_2259[kernel] = (fp_t*) malloc(1*1 * sizeof(fp_t));
}



kernels[165] = buffer_2259;
...
biases[246] = buffer_layer3_20_bn0_weight;
...
biases[247] = buffer_layer3_20_bn0_bias;
...
biases[248] = buffer_layer3_20_bn0_running_mean;
...
biases[249] = buffer_layer3_20_bn0_running_var;
...
// Inputs
// (1, 1, 1)
buffer_2260 = (fp_t**) malloc(1 * sizeof(fp_t*));

for(uint32_t kernel = 0; kernel < 1; kernel++){
    buffer_2260[kernel] = (fp_t*) malloc(1*1 * sizeof(fp_t));
}



kernels[167] = buffer_2260;
...
kernels[169] = &buffer_layer3_20_se_fc_0_weight;
...
biases[252] = buffer_layer3_20_se_fc_0_bias;
...
// Inputs
// (1,)
buffer_layer3_20_se_fc_1_weight = (fp_t*) malloc(1 * sizeof(fp_t));



biases[253] = buffer_layer3_20_se_fc_1_weight;
...
kernels[170] = &buffer_layer3_20_se_fc_2_weight;
...
biases[254] = buffer_layer3_20_se_fc_2_bias;
...
// Inputs
// (1, 1, 1)
buffer_2263 = (fp_t**) malloc(1 * sizeof(fp_t*));

for(uint32_t kernel = 0; kernel < 1; kernel++){
    buffer_2263[kernel] = (fp_t*) malloc(1*1 * sizeof(fp_t));
}



kernels[171] = buffer_2263;
...
biases[255] = buffer_layer3_21_bn0_weight;
...
biases[256] = buffer_layer3_21_bn0_bias;
...
biases[257] = buffer_layer3_21_bn0_running_mean;
...
biases[258] = buffer_layer3_21_bn0_running_var;
...
// Inputs
// (1, 1, 1)
buffer_2264 = (fp_t**) malloc(1 * sizeof(fp_t*));

for(uint32_t kernel = 0; kernel < 1; kernel++){
    buffer_2264[kernel] = (fp_t*) malloc(1*1 * sizeof(fp_t));
}



kernels[173] = buffer_2264;
...
kernels[175] = &buffer_layer3_21_se_fc_0_weight;
...
biases[261] = buffer_layer3_21_se_fc_0_bias;
...
// Inputs
// (1,)
buffer_layer3_21_se_fc_1_weight = (fp_t*) malloc(1 * sizeof(fp_t));



biases[262] = buffer_layer3_21_se_fc_1_weight;
...
kernels[176] = &buffer_layer3_21_se_fc_2_weight;
...
biases[263] = buffer_layer3_21_se_fc_2_bias;
...
// Inputs
// (1, 1, 1)
buffer_2267 = (fp_t**) malloc(1 * sizeof(fp_t*));

for(uint32_t kernel = 0; kernel < 1; kernel++){
    buffer_2267[kernel] = (fp_t*) malloc(1*1 * sizeof(fp_t));
}



kernels[177] = buffer_2267;
...
biases[264] = buffer_layer3_22_bn0_weight;
...
biases[265] = buffer_layer3_22_bn0_bias;
...
biases[266] = buffer_layer3_22_bn0_running_mean;
...
biases[267] = buffer_layer3_22_bn0_running_var;
...
// Inputs
// (1, 1, 1)
buffer_2268 = (fp_t**) malloc(1 * sizeof(fp_t*));

for(uint32_t kernel = 0; kernel < 1; kernel++){
    buffer_2268[kernel] = (fp_t*) malloc(1*1 * sizeof(fp_t));
}



kernels[179] = buffer_2268;
...
kernels[181] = &buffer_layer3_22_se_fc_0_weight;
...
biases[270] = buffer_layer3_22_se_fc_0_bias;
...
// Inputs
// (1,)
buffer_layer3_22_se_fc_1_weight = (fp_t*) malloc(1 * sizeof(fp_t));



biases[271] = buffer_layer3_22_se_fc_1_weight;
...
kernels[182] = &buffer_layer3_22_se_fc_2_weight;
...
biases[272] = buffer_layer3_22_se_fc_2_bias;
...
// Inputs
// (1, 1, 1)
buffer_2271 = (fp_t**) malloc(1 * sizeof(fp_t*));

for(uint32_t kernel = 0; kernel < 1; kernel++){
    buffer_2271[kernel] = (fp_t*) malloc(1*1 * sizeof(fp_t));
}



kernels[183] = buffer_2271;
...
biases[273] = buffer_layer4_0_bn0_weight;
...
biases[274] = buffer_layer4_0_bn0_bias;
...
biases[275] = buffer_layer4_0_bn0_running_mean;
...
biases[276] = buffer_layer4_0_bn0_running_var;
...
// Inputs
// (1, 1, 1)
buffer_2272 = (fp_t**) malloc(1 * sizeof(fp_t*));

for(uint32_t kernel = 0; kernel < 1; kernel++){
    buffer_2272[kernel] = (fp_t*) malloc(1*1 * sizeof(fp_t));
}



kernels[185] = buffer_2272;
...
kernels[187] = &buffer_layer4_0_se_fc_0_weight;
...
biases[279] = buffer_layer4_0_se_fc_0_bias;
...
// Inputs
// (1,)
buffer_layer4_0_se_fc_1_weight = (fp_t*) malloc(1 * sizeof(fp_t));



biases[280] = buffer_layer4_0_se_fc_1_weight;
...
kernels[188] = &buffer_layer4_0_se_fc_2_weight;
...
biases[281] = buffer_layer4_0_se_fc_2_bias;
...
// Inputs
// (1, 1, 1)
buffer_2275 = (fp_t**) malloc(1 * sizeof(fp_t*));

for(uint32_t kernel = 0; kernel < 1; kernel++){
    buffer_2275[kernel] = (fp_t*) malloc(1*1 * sizeof(fp_t));
}



kernels[190] = buffer_2275;
...
biases[283] = buffer_layer4_1_bn0_weight;
...
biases[284] = buffer_layer4_1_bn0_bias;
...
biases[285] = buffer_layer4_1_bn0_running_mean;
...
biases[286] = buffer_layer4_1_bn0_running_var;
...
// Inputs
// (1, 1, 1)
buffer_2276 = (fp_t**) malloc(1 * sizeof(fp_t*));

for(uint32_t kernel = 0; kernel < 1; kernel++){
    buffer_2276[kernel] = (fp_t*) malloc(1*1 * sizeof(fp_t));
}



kernels[192] = buffer_2276;
...
kernels[194] = &buffer_layer4_1_se_fc_0_weight;
...
biases[289] = buffer_layer4_1_se_fc_0_bias;
...
// Inputs
// (1,)
buffer_layer4_1_se_fc_1_weight = (fp_t*) malloc(1 * sizeof(fp_t));



biases[290] = buffer_layer4_1_se_fc_1_weight;
...
kernels[195] = &buffer_layer4_1_se_fc_2_weight;
...
biases[291] = buffer_layer4_1_se_fc_2_bias;
...
// Inputs
// (1, 1, 1)
buffer_2279 = (fp_t**) malloc(1 * sizeof(fp_t*));

for(uint32_t kernel = 0; kernel < 1; kernel++){
    buffer_2279[kernel] = (fp_t*) malloc(1*1 * sizeof(fp_t));
}



kernels[196] = buffer_2279;
...
biases[292] = buffer_layer4_2_bn0_weight;
...
biases[293] = buffer_layer4_2_bn0_bias;
...
biases[294] = buffer_layer4_2_bn0_running_mean;
...
biases[295] = buffer_layer4_2_bn0_running_var;
...
// Inputs
// (1, 1, 1)
buffer_2280 = (fp_t**) malloc(1 * sizeof(fp_t*));

for(uint32_t kernel = 0; kernel < 1; kernel++){
    buffer_2280[kernel] = (fp_t*) malloc(1*1 * sizeof(fp_t));
}



kernels[198] = buffer_2280;
...
kernels[200] = &buffer_layer4_2_se_fc_0_weight;
...
biases[298] = buffer_layer4_2_se_fc_0_bias;
...
// Inputs
// (1,)
buffer_layer4_2_se_fc_1_weight = (fp_t*) malloc(1 * sizeof(fp_t));



biases[299] = buffer_layer4_2_se_fc_1_weight;
...
kernels[201] = &buffer_layer4_2_se_fc_2_weight;
...
biases[300] = buffer_layer4_2_se_fc_2_bias;
...
// Inputs
// (1, 1, 1)
buffer_2283 = (fp_t**) malloc(1 * sizeof(fp_t*));

for(uint32_t kernel = 0; kernel < 1; kernel++){
    buffer_2283[kernel] = (fp_t*) malloc(1*1 * sizeof(fp_t));
}



kernels[202] = buffer_2283;
...
biases[303] = buffer_bn2_running_mean;
...
biases[304] = buffer_bn2_running_var;
...
biases[308] = buffer_bn3_running_mean;
...
biases[309] = buffer_bn3_running_var;
