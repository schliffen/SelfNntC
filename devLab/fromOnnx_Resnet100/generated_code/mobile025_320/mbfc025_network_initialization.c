#include " mbfc025_network_initialization.h"

void mbfc025_initialize_network() {

mbfc025_kernels = (fp_t***) malloc(56 * sizeof(fp_t**));
mbfc025_biases = (fp_t**) malloc(56 * sizeof(fp_t*));
...
for(uint32_t output = 0; output < 8; output++){
    buffer_587[output] = (fp_t*) malloc(160*160 * sizeof(fp_t));
}
...
for(uint32_t output = 0; output < 8; output++){
    buffer_303[output] = (fp_t*) malloc(160*160 * sizeof(fp_t));
}
...
for(uint32_t output = 0; output < 8; output++){
    buffer_590[output] = (fp_t*) malloc(160*160 * sizeof(fp_t));
}
...
for(uint32_t output = 0; output < 8; output++){
    buffer_306[output] = (fp_t*) malloc(160*160 * sizeof(fp_t));
}
...
for(uint32_t output = 0; output < 16; output++){
    buffer_593[output] = (fp_t*) malloc(160*160 * sizeof(fp_t));
}
...
for(uint32_t output = 0; output < 16; output++){
    buffer_309[output] = (fp_t*) malloc(160*160 * sizeof(fp_t));
}
...
for(uint32_t output = 0; output < 16; output++){
    buffer_596[output] = (fp_t*) malloc(80*80 * sizeof(fp_t));
}
...
for(uint32_t output = 0; output < 16; output++){
    buffer_312[output] = (fp_t*) malloc(80*80 * sizeof(fp_t));
}
...
for(uint32_t output = 0; output < 32; output++){
    buffer_599[output] = (fp_t*) malloc(80*80 * sizeof(fp_t));
}
...
for(uint32_t output = 0; output < 32; output++){
    buffer_315[output] = (fp_t*) malloc(80*80 * sizeof(fp_t));
}
...
for(uint32_t output = 0; output < 32; output++){
    buffer_602[output] = (fp_t*) malloc(80*80 * sizeof(fp_t));
}
...
for(uint32_t output = 0; output < 32; output++){
    buffer_318[output] = (fp_t*) malloc(80*80 * sizeof(fp_t));
}
...
for(uint32_t output = 0; output < 32; output++){
    buffer_605[output] = (fp_t*) malloc(80*80 * sizeof(fp_t));
}
...
for(uint32_t output = 0; output < 32; output++){
    buffer_321[output] = (fp_t*) malloc(80*80 * sizeof(fp_t));
}
...
for(uint32_t output = 0; output < 32; output++){
    buffer_608[output] = (fp_t*) malloc(40*40 * sizeof(fp_t));
}
...
for(uint32_t output = 0; output < 32; output++){
    buffer_324[output] = (fp_t*) malloc(40*40 * sizeof(fp_t));
}
...
for(uint32_t output = 0; output < 64; output++){
    buffer_611[output] = (fp_t*) malloc(40*40 * sizeof(fp_t));
}
...
for(uint32_t output = 0; output < 64; output++){
    buffer_327[output] = (fp_t*) malloc(40*40 * sizeof(fp_t));
}
...
for(uint32_t output = 0; output < 64; output++){
    buffer_614[output] = (fp_t*) malloc(40*40 * sizeof(fp_t));
}
...
for(uint32_t output = 0; output < 64; output++){
    buffer_330[output] = (fp_t*) malloc(40*40 * sizeof(fp_t));
}
...
for(uint32_t output = 0; output < 64; output++){
    buffer_617[output] = (fp_t*) malloc(40*40 * sizeof(fp_t));
}
...
for(uint32_t output = 0; output < 64; output++){
    buffer_333[output] = (fp_t*) malloc(40*40 * sizeof(fp_t));
}
...
for(uint32_t output = 0; output < 64; output++){
    buffer_620[output] = (fp_t*) malloc(20*20 * sizeof(fp_t));
}
...
for(uint32_t output = 0; output < 64; output++){
    buffer_336[output] = (fp_t*) malloc(20*20 * sizeof(fp_t));
}
...
for(uint32_t output = 0; output < 128; output++){
    buffer_623[output] = (fp_t*) malloc(20*20 * sizeof(fp_t));
}
...
for(uint32_t output = 0; output < 128; output++){
    buffer_339[output] = (fp_t*) malloc(20*20 * sizeof(fp_t));
}
...
for(uint32_t output = 0; output < 128; output++){
    buffer_626[output] = (fp_t*) malloc(20*20 * sizeof(fp_t));
}
...
for(uint32_t output = 0; output < 128; output++){
    buffer_342[output] = (fp_t*) malloc(20*20 * sizeof(fp_t));
}
...
for(uint32_t output = 0; output < 128; output++){
    buffer_629[output] = (fp_t*) malloc(20*20 * sizeof(fp_t));
}
...
for(uint32_t output = 0; output < 128; output++){
    buffer_345[output] = (fp_t*) malloc(20*20 * sizeof(fp_t));
}
...
for(uint32_t output = 0; output < 128; output++){
    buffer_632[output] = (fp_t*) malloc(20*20 * sizeof(fp_t));
}
...
for(uint32_t output = 0; output < 128; output++){
    buffer_348[output] = (fp_t*) malloc(20*20 * sizeof(fp_t));
}
...
for(uint32_t output = 0; output < 128; output++){
    buffer_635[output] = (fp_t*) malloc(20*20 * sizeof(fp_t));
}
...
for(uint32_t output = 0; output < 128; output++){
    buffer_351[output] = (fp_t*) malloc(20*20 * sizeof(fp_t));
}
...
for(uint32_t output = 0; output < 128; output++){
    buffer_638[output] = (fp_t*) malloc(20*20 * sizeof(fp_t));
}
...
for(uint32_t output = 0; output < 128; output++){
    buffer_354[output] = (fp_t*) malloc(20*20 * sizeof(fp_t));
}
...
for(uint32_t output = 0; output < 128; output++){
    buffer_641[output] = (fp_t*) malloc(20*20 * sizeof(fp_t));
}
...
for(uint32_t output = 0; output < 128; output++){
    buffer_357[output] = (fp_t*) malloc(20*20 * sizeof(fp_t));
}
...
for(uint32_t output = 0; output < 128; output++){
    buffer_644[output] = (fp_t*) malloc(20*20 * sizeof(fp_t));
}
...
for(uint32_t output = 0; output < 128; output++){
    buffer_360[output] = (fp_t*) malloc(20*20 * sizeof(fp_t));
}
...
for(uint32_t output = 0; output < 128; output++){
    buffer_647[output] = (fp_t*) malloc(20*20 * sizeof(fp_t));
}
...
for(uint32_t output = 0; output < 128; output++){
    buffer_363[output] = (fp_t*) malloc(20*20 * sizeof(fp_t));
}
...
for(uint32_t output = 0; output < 128; output++){
    buffer_650[output] = (fp_t*) malloc(20*20 * sizeof(fp_t));
}
...
for(uint32_t output = 0; output < 128; output++){
    buffer_366[output] = (fp_t*) malloc(20*20 * sizeof(fp_t));
}
...
for(uint32_t output = 0; output < 128; output++){
    buffer_653[output] = (fp_t*) malloc(20*20 * sizeof(fp_t));
}
...
for(uint32_t output = 0; output < 128; output++){
    buffer_369[output] = (fp_t*) malloc(20*20 * sizeof(fp_t));
}
...
for(uint32_t output = 0; output < 128; output++){
    buffer_656[output] = (fp_t*) malloc(10*10 * sizeof(fp_t));
}
...
for(uint32_t output = 0; output < 128; output++){
    buffer_372[output] = (fp_t*) malloc(10*10 * sizeof(fp_t));
}
...
for(uint32_t output = 0; output < 256; output++){
    buffer_659[output] = (fp_t*) malloc(10*10 * sizeof(fp_t));
}
...
for(uint32_t output = 0; output < 256; output++){
    buffer_375[output] = (fp_t*) malloc(10*10 * sizeof(fp_t));
}
...
for(uint32_t output = 0; output < 256; output++){
    buffer_662[output] = (fp_t*) malloc(10*10 * sizeof(fp_t));
}
...
for(uint32_t output = 0; output < 256; output++){
    buffer_378[output] = (fp_t*) malloc(10*10 * sizeof(fp_t));
}
...
for(uint32_t output = 0; output < 256; output++){
    buffer_665[output] = (fp_t*) malloc(10*10 * sizeof(fp_t));
}
...
for(uint32_t output = 0; output < 256; output++){
    buffer_381[output] = (fp_t*) malloc(10*10 * sizeof(fp_t));
}
...
for(uint32_t output = 0; output < 64; output++){
    buffer_668[output] = (fp_t*) malloc(40*40 * sizeof(fp_t));
}
...
for(uint32_t output = 0; output < 64; output++){
    buffer_384[output] = (fp_t*) malloc(40*40 * sizeof(fp_t));
}
...
for(uint32_t output = 0; output < 64; output++){
    buffer_671[output] = (fp_t*) malloc(20*20 * sizeof(fp_t));
}
...
for(uint32_t output = 0; output < 64; output++){
    buffer_387[output] = (fp_t*) malloc(20*20 * sizeof(fp_t));
}
...
for(uint32_t output = 0; output < 64; output++){
    buffer_674[output] = (fp_t*) malloc(10*10 * sizeof(fp_t));
}
...
for(uint32_t output = 0; output < 64; output++){
    buffer_390[output] = (fp_t*) malloc(10*10 * sizeof(fp_t));
}
...
for(uint32_t output = 0; output < 64; output++){
    buffer_407[output] = (fp_t*) malloc(20*20 * sizeof(fp_t));
}
...
for(uint32_t output = 0; output < 64; output++){
    buffer_408[output] = (fp_t*) malloc(20*20 * sizeof(fp_t));
}
...
for(uint32_t output = 0; output < 64; output++){
    buffer_677[output] = (fp_t*) malloc(20*20 * sizeof(fp_t));
}
...
for(uint32_t output = 0; output < 64; output++){
    buffer_411[output] = (fp_t*) malloc(20*20 * sizeof(fp_t));
}
...
for(uint32_t output = 0; output < 64; output++){
    buffer_428[output] = (fp_t*) malloc(40*40 * sizeof(fp_t));
}
...
for(uint32_t output = 0; output < 64; output++){
    buffer_429[output] = (fp_t*) malloc(40*40 * sizeof(fp_t));
}
...
for(uint32_t output = 0; output < 64; output++){
    buffer_680[output] = (fp_t*) malloc(40*40 * sizeof(fp_t));
}
...
for(uint32_t output = 0; output < 64; output++){
    buffer_432[output] = (fp_t*) malloc(40*40 * sizeof(fp_t));
}
...
for(uint32_t output = 0; output < 32; output++){
    buffer_683[output] = (fp_t*) malloc(40*40 * sizeof(fp_t));
}
...
for(uint32_t output = 0; output < 16; output++){
    buffer_686[output] = (fp_t*) malloc(40*40 * sizeof(fp_t));
}
...
for(uint32_t output = 0; output < 16; output++){
    buffer_437[output] = (fp_t*) malloc(40*40 * sizeof(fp_t));
}
...
for(uint32_t output = 0; output < 16; output++){
    buffer_689[output] = (fp_t*) malloc(40*40 * sizeof(fp_t));
}
...
for(uint32_t output = 0; output < 16; output++){
    buffer_692[output] = (fp_t*) malloc(40*40 * sizeof(fp_t));
}
...
for(uint32_t output = 0; output < 16; output++){
    buffer_442[output] = (fp_t*) malloc(40*40 * sizeof(fp_t));
}
...
for(uint32_t output = 0; output < 16; output++){
    buffer_695[output] = (fp_t*) malloc(40*40 * sizeof(fp_t));
}
...
for(uint32_t output = 0; output < 64; output++){
    buffer_445[output] = (fp_t*) malloc(40*40 * sizeof(fp_t));
}
...
for(uint32_t output = 0; output < 64; output++){
    buffer_446[output] = (fp_t*) malloc(40*40 * sizeof(fp_t));
}
...
for(uint32_t output = 0; output < 32; output++){
    buffer_698[output] = (fp_t*) malloc(20*20 * sizeof(fp_t));
}
...
for(uint32_t output = 0; output < 16; output++){
    buffer_701[output] = (fp_t*) malloc(20*20 * sizeof(fp_t));
}
...
for(uint32_t output = 0; output < 16; output++){
    buffer_451[output] = (fp_t*) malloc(20*20 * sizeof(fp_t));
}
...
for(uint32_t output = 0; output < 16; output++){
    buffer_704[output] = (fp_t*) malloc(20*20 * sizeof(fp_t));
}
...
for(uint32_t output = 0; output < 16; output++){
    buffer_707[output] = (fp_t*) malloc(20*20 * sizeof(fp_t));
}
...
for(uint32_t output = 0; output < 16; output++){
    buffer_456[output] = (fp_t*) malloc(20*20 * sizeof(fp_t));
}
...
for(uint32_t output = 0; output < 16; output++){
    buffer_710[output] = (fp_t*) malloc(20*20 * sizeof(fp_t));
}
...
for(uint32_t output = 0; output < 64; output++){
    buffer_459[output] = (fp_t*) malloc(20*20 * sizeof(fp_t));
}
...
for(uint32_t output = 0; output < 64; output++){
    buffer_460[output] = (fp_t*) malloc(20*20 * sizeof(fp_t));
}
...
for(uint32_t output = 0; output < 32; output++){
    buffer_713[output] = (fp_t*) malloc(10*10 * sizeof(fp_t));
}
...
for(uint32_t output = 0; output < 16; output++){
    buffer_716[output] = (fp_t*) malloc(10*10 * sizeof(fp_t));
}
...
for(uint32_t output = 0; output < 16; output++){
    buffer_465[output] = (fp_t*) malloc(10*10 * sizeof(fp_t));
}
...
for(uint32_t output = 0; output < 16; output++){
    buffer_719[output] = (fp_t*) malloc(10*10 * sizeof(fp_t));
}
...
for(uint32_t output = 0; output < 16; output++){
    buffer_722[output] = (fp_t*) malloc(10*10 * sizeof(fp_t));
}
...
for(uint32_t output = 0; output < 16; output++){
    buffer_470[output] = (fp_t*) malloc(10*10 * sizeof(fp_t));
}
...
for(uint32_t output = 0; output < 16; output++){
    buffer_725[output] = (fp_t*) malloc(10*10 * sizeof(fp_t));
}
...
for(uint32_t output = 0; output < 64; output++){
    buffer_473[output] = (fp_t*) malloc(10*10 * sizeof(fp_t));
}
...
for(uint32_t output = 0; output < 64; output++){
    buffer_474[output] = (fp_t*) malloc(10*10 * sizeof(fp_t));
}
...
for(uint32_t output = 0; output < 8; output++){
    buffer_475[output] = (fp_t*) malloc(40*40 * sizeof(fp_t));
}
...
// Outputs
// (1, 40, 40, 8)
buffer_476 = (fp_t**) malloc(40 * sizeof(fp_t*));

for(uint32_t output = 0; output < 40; output++){
    buffer_476[output] = (fp_t*) malloc(40*8 * sizeof(fp_t));
}
...
// Outputs
// (1, 3200, 4)
buffer_486 = (fp_t**) malloc(3200 * sizeof(fp_t*));
...
for(uint32_t output = 0; output < 8; output++){
    buffer_487[output] = (fp_t*) malloc(20*20 * sizeof(fp_t));
}
...
// Outputs
// (1, 20, 20, 8)
buffer_488 = (fp_t**) malloc(20 * sizeof(fp_t*));

for(uint32_t output = 0; output < 20; output++){
    buffer_488[output] = (fp_t*) malloc(20*8 * sizeof(fp_t));
}
...
// Outputs
// (1, 800, 4)
buffer_498 = (fp_t**) malloc(800 * sizeof(fp_t*));
...
for(uint32_t output = 0; output < 8; output++){
    buffer_499[output] = (fp_t*) malloc(10*10 * sizeof(fp_t));
}
...
// Outputs
// (1, 10, 10, 8)
buffer_500 = (fp_t**) malloc(10 * sizeof(fp_t*));

for(uint32_t output = 0; output < 10; output++){
    buffer_500[output] = (fp_t*) malloc(10*8 * sizeof(fp_t));
}
...
// Outputs
// (1, 200, 4)
buffer_510 = (fp_t**) malloc(200 * sizeof(fp_t*));
...
for(uint32_t output = 0; output < 4; output++){
    buffer_512[output] = (fp_t*) malloc(40*40 * sizeof(fp_t));
}
...
// Outputs
// (1, 40, 40, 4)
buffer_513 = (fp_t**) malloc(40 * sizeof(fp_t*));

for(uint32_t output = 0; output < 40; output++){
    buffer_513[output] = (fp_t*) malloc(40*4 * sizeof(fp_t));
}
...
// Outputs
// (1, 3200, 2)
buffer_523 = (fp_t**) malloc(3200 * sizeof(fp_t*));
...
for(uint32_t output = 0; output < 4; output++){
    buffer_524[output] = (fp_t*) malloc(20*20 * sizeof(fp_t));
}
...
// Outputs
// (1, 20, 20, 4)
buffer_525 = (fp_t**) malloc(20 * sizeof(fp_t*));

for(uint32_t output = 0; output < 20; output++){
    buffer_525[output] = (fp_t*) malloc(20*4 * sizeof(fp_t));
}
...
// Outputs
// (1, 800, 2)
buffer_535 = (fp_t**) malloc(800 * sizeof(fp_t*));
...
for(uint32_t output = 0; output < 4; output++){
    buffer_536[output] = (fp_t*) malloc(10*10 * sizeof(fp_t));
}
...
// Outputs
// (1, 10, 10, 4)
buffer_537 = (fp_t**) malloc(10 * sizeof(fp_t*));

for(uint32_t output = 0; output < 10; output++){
    buffer_537[output] = (fp_t*) malloc(10*4 * sizeof(fp_t));
}
...
// Outputs
// (1, 200, 2)
buffer_547 = (fp_t**) malloc(200 * sizeof(fp_t*));
...
// Outputs
// (1, 4200, 2)
buffer_548 = (fp_t**) malloc(4200 * sizeof(fp_t*));
...
for(uint32_t output = 0; output < 20; output++){
    buffer_549[output] = (fp_t*) malloc(40*40 * sizeof(fp_t));
}
...
// Outputs
// (1, 40, 40, 20)
buffer_550 = (fp_t**) malloc(40 * sizeof(fp_t*));

for(uint32_t output = 0; output < 40; output++){
    buffer_550[output] = (fp_t*) malloc(40*20 * sizeof(fp_t));
}
...
// Outputs
// (1, 3200, 10)
buffer_560 = (fp_t**) malloc(3200 * sizeof(fp_t*));
...
for(uint32_t output = 0; output < 20; output++){
    buffer_561[output] = (fp_t*) malloc(20*20 * sizeof(fp_t));
}
...
// Outputs
// (1, 20, 20, 20)
buffer_562 = (fp_t**) malloc(20 * sizeof(fp_t*));

for(uint32_t output = 0; output < 20; output++){
    buffer_562[output] = (fp_t*) malloc(20*20 * sizeof(fp_t));
}
...
// Outputs
// (1, 800, 10)
buffer_572 = (fp_t**) malloc(800 * sizeof(fp_t*));
...
for(uint32_t output = 0; output < 20; output++){
    buffer_573[output] = (fp_t*) malloc(10*10 * sizeof(fp_t));
}
...
// Outputs
// (1, 10, 10, 20)
buffer_574 = (fp_t**) malloc(10 * sizeof(fp_t*));

for(uint32_t output = 0; output < 10; output++){
    buffer_574[output] = (fp_t*) malloc(10*20 * sizeof(fp_t));
}
...
// Outputs
// (1, 200, 10)
buffer_584 = (fp_t**) malloc(200 * sizeof(fp_t*));
