...
biases = (fp_t**) malloc(5 * sizeof(fp_t*));
...
biases[3] = buffer_bn_running_mean;
...
biases[4] = buffer_bn_running_var;


// Outputs
// (1, 200704)
buffer_346 = (fp_t*) malloc(200704 * sizeof(fp_t));
...
// Outputs
// (1, 1)
buffer_347 = (fp_t*) malloc(1 * sizeof(fp_t));
