...
// new to handle mobilenet layers
void concatenate_2D_naive(fp_t** input_channels, const uint16_t** input_shape,
                          const uint16_t dimension, const uint16_t num_inputs, fp_t* output_channel);


void concatenate_2D_output(fp_t*** input_channels, const uint16_t** input_shape, const uint16_t dimension, const uint16_t num_inputs, fp_t** output_channel);
